...
export function musclesForLine(line: string): string[] {
...
export function extractSetsRepsFromLine(line: string): { sets: number; reps: number }[] {
  const out: { sets: number; reps: number }[] = [];
