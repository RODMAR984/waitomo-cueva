...
export default function AdminObservabilityScreen({ navigation }) {
  ...
  const styles = useMemo(
    () =>
      StyleSheet.create({
        root: { flex: 1, padding: 20, paddingTop: 56 },
        ...
        statLabel: { color: t.subText, fontSize: 12 },
        ...
        perfTitle: { color: t.text, fontSize: 14, fontWeight: '800', marginBottom: 8 },
        ...
        perfName: { color: t.text, fontSize: 12, fontWeight: '700', marginBottom: 4 },
        ...
        slowTitle: { color: t.text, fontSize: 14, fontWeight: '800', marginBottom: 8 },
        slowRow: {
          borderTopWidth: 1,
        ...
        slowName: { color: t.text, fontSize: 12, fontWeight: '700' },
        ...
        actionTxt: { color: t.text, fontSize: 13, fontWeight: '700' },
        actionTxtPrimary: { ...t.buttonPrimaryText, fontSize: 13, fontWeight: '800' },
        searchInput: {
          borderWidth: 1,
          borderColor: t.overlayBorder,
          borderRadius: 10,
        ...
        filterTxt: { color: t.subText, fontSize: 12, fontWeight: '700' },
        filterTxtOn: { color: t.brand },
        resultLine: { color: t.subText, fontSize: 12, marginBottom: 8 },
        list: { flex: 1, borderWidth: 1, borderColor: t.overlayBorder, borderRadius: 12, backgroundColor: t.boxBg },
        row: {
          borderBottomWidth: 1,
        ...
        rowSub: { color: t.subText, fontSize: 12, marginTop: 2 },
