  ...
  const styles = useMemo(
    () =>
      StyleSheet.create({
        ...
        title: { color: FE.text, fontSize: 22, fontWeight: '700', marginBottom: 6 },
        subtitle: { color: FE.sub, fontSize: 13, marginBottom: 16, lineHeight: 18 },
        label: { color: FE.sub, fontSize: 14, marginBottom: 8, fontWeight: '600' },
        input: {
        ...
        previewBrand: { color: previewTokens.text, fontSize: 14, fontWeight: '800', flex: 1 },
        previewBody: { flex: 1, padding: 12, justifyContent: 'flex-end' },
        previewCard: {
          borderRadius: 12,
          padding: 12,
        ...
        previewCardText: { color: previewTokens.subText, fontSize: 12 },
        colorRow: { flexDirection: 'row', alignItems: 'center', gap: 12, marginBottom: 10 },
        colorPreview: {
          width: 44,
          height: 44,
          borderRadius: 10,
        ...
        colorHint: { color: FE.sub, fontSize: 12, flex: 1 },
        hueScroller: { paddingVertical: 4 },
        hueChip: {
          width: 26,
          height: 26,
          borderRadius: 13,
        ...
        typeBtnText: { color: FE.sub, fontWeight: '600' },
        ...
        chipText: { color: FE.sub, fontSize: 13 },
        ...
        logoBtnText: { color: validAccent, fontSize: 14, fontWeight: '600' },
        bgPreviewWrap: {
          width: '100%',
          height: 120,
          borderRadius: 12,
        ...
        btnText: { color: FE.text, fontWeight: '700', fontSize: 16 },
      }),
