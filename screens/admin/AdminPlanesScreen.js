  ...
  const styles = useMemo(
    () =>
      StyleSheet.create({
        ...
        segBtnTxt: { color: t.text, fontSize: MOBILE_TYPE.body, fontWeight: '600' },
        segBtnTxtOn: { color: t.brand },
        hint: { color: t.placeholder, fontSize: MOBILE_TYPE.caption, lineHeight: 17, marginBottom: 10 },
        previewPill: {
        ...
        previewPillTxt: { color: '#92400e', fontSize: MOBILE_TYPE.caption, fontWeight: '700' },
        slotCard: {
          borderWidth: 1,
          borderColor: t.overlayBorder,
          borderRadius: MOBILE_RADII.sm,
        ...
        dowChipTxt: { color: t.subText, fontSize: MOBILE_TYPE.caption, fontWeight: '700' },
        ...
        addSlotTxt: { color: t.brand, fontWeight: '700', fontSize: MOBILE_TYPE.body },
      }),
